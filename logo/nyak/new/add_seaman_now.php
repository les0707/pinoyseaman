...
exit;
  ...
  $email_message = "
  <font size = '2' face = 'verdana'>Welcome to PinoySeaman $first_name. Below is your login account.\n \n
  Email : <strong>$email</strong> 
  Password : <strong>$newid</strong>
...
if(!$mail->Send()) {
  ...
  $link = "index.php";  
  $message =  "<font color='blue'>Registration Successful! your pinoyseaman auto generated password was forwarded on your email ( $email ). <br/> Please check both INBOX or SPAM folder.</font>  
  ";
  include "./action.php"; 
  exit;
}
